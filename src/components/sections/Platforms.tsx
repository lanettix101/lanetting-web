...
const platformMeta: Record<string, { img: string; link: string }> = {
  Legiit: {
...
export default function Platforms() {
  ...
  return (
    <section id="platforms" className="py-12 md:py-16 bg-brand-surface border-y border-brand-border">
              ...
              >
                <div className="flex items-start gap-6">
                  <div className="w-20 h-20 shrink-0 bg-brand-surface border border-brand-border rounded-lg overflow-hidden flex items-center justify-center group-hover:border-brand-primary transition-colors">
                    <img
                      src={`${import.meta.env.BASE_URL}${meta.img}`}
                      alt={platform.name}
