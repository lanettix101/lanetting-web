export const translations = {
  en: {
    ...
    services: {
      ...
      title: "Key Services & Solutions",
      desc: "Specialized technical solutions designed to scale and optimize your digital infrastructure."
    },
    platforms: {
    ...
    serviceDetail: {
      ...
      viewOnMarketplaces: "Contract in Freelance Marketplaces",
  ...
  es: {
    ...
    services: {
      command: "sudo get_services",
      title: "Servicios y Soluciones Clave",
      desc: "Soluciones técnicas especializadas diseñadas para escalar y optimizar tu infraestructura digital."
    },
    platforms: {
      command: "display --profiles",
    ...
    serviceDetail: {
      ...
      viewOnMarketplaces: "Contratar en Marketplaces",
